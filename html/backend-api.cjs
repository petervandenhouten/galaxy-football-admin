...
const pool = new Pool({
  connectionString: process.env.PG_CONNECTION_STRING || 'postgresql://galaxyfootballdbdev_user:RWzXT6AHSoi2zlPVh5yft3h30Ma0qIvG@dpg-d7gfd01kh4rs73egbf3g-a.virginia-postgres.render.com/galaxyfootballdbdev',
